(module
 ...
 (export "matrix_multiply" (func $assembly/index/matrix_multiply))
 ...
 (start $~start)
 (func $assembly/index/fibonacci (type $0) (param $0 i32) (result i32)
  local.get $0
  i32.const 1
  i32.le_s
  if
 ...
 (func $assembly/index/matrix_multiply (type $0) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
